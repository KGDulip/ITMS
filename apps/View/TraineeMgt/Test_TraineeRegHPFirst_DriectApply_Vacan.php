...
$Stu_Student_Surname = filter_input(INPUT_POST, 'Stu_Student_Surname', FILTER_SANITIZE_STRING);
$inputs['Stu_Student_Surname'] = $Stu_Student_Surname;

if ($Stu_Student_Surname) {
    $Stu_Student_Surname = trim($Stu_Student_Surname);
    if ($Stu_Student_Surname === '') {
        $errors['Stu_Student_Surname'] = NAME_REQUIRED;
    }
} else {
    $errors['Stu_Student_Surname'] = NAME_REQUIRED;
}
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required="" autofocus="" name="Stu_Student_NIC" minlength="10" maxlength="12" class="form-control" id="Stu_Student_NIC" placeholder="802141122V or 19802141122" >
                                                </div>
                                                <div class="form-group">
                                                    <label>Initial </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="Stu_Mobile" class="form-control" id="Stu_Mobile" pattern="[0-9]{10}" minlength="10" maxlength="10" placeholder="0712345678">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="Stu_Student_Surname" id="Stu_Student_Surname" placeholder="Surname" value="<?php echo $inputs['Stu_Student_Surname'] ?? '' ?>" class="<?php echo isset($errors['Stu_Student_Surname']) ? 'error' : ''  ?>">
                                                    <small><?php echo $errors['Stu_Student_Surname'] ?? '' ?></small>
                                                </div> 
                                                <div class="form-group">
                                                    <label>Gender</label>
