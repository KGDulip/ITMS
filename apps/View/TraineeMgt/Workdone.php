                        ...
                        <div class="card card-default">
                            ...
                            <form id="quickForm" method="POST" action="../../Module/TraineeMgt/_DiscipRec.php">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Disci_Stu_ID" class="form-control" id="Disci_Stu_ID" value="<?php if(isset($_GET['Disci_ID'])) echo $Disci_Stu_ID;?>" />
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Disci_Office_ID" class="form-control" id="Disci_Office_ID" value="<?php if(isset($_GET['Disci_ID'])) echo $Disci_Office_ID;?>" />
                                            </div>
                                            <div class="form-group">
                                                <label>Date</label>
                                                <input type="date" name="Disci_Record_Date" class="form-control" id="Disci_Record_Date" value="<?php if(isset($_GET['Disci_ID'])) echo $Disci_Record_Date;?>" />
                                            </div> 
                                ...
                                <div class="card-footer">
                                    <input type="submit" value="Record" class="btn btn-primary" Name="New">
