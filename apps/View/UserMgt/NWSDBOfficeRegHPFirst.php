                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="" name="Sec_Head" class="form-control" id="Sec_Head">
                                        </div>
                                        <div class="form-group">
                                            <label>Officer's Name</label>
                                            <input type="text" required="" name="Sec_Autho_OfficerName" class="form-control" id="Sec_Autho_OfficerName" placeholder="Perera A.B.C.">
                                        </div>
