                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-default">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Insti_Name" class="form-control" id="Insti_Name" placeholder="UNIVOTEC">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" name="Insti_Email" class="form-control" id="Insti_Email" placeholder="abc@gmail.com" >
                                        </div> 
                            ...
                            <div class="card-footer">
                                ...
                                <a href="View_InstituteRegistration.php" class="btn btn-primary">View</a>
                            </div>
                            </form>
                        </div>
                        <!-- /.card -->
