            ...
            <div class="content-wrapper">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                    <td><?php echo $row['Insti_ID']; ?> </td>
                    <td><?php echo $row['Insti_Name']; ?> </td>
                    <td><?php echo $row['Insti_Branch']; ?> </td>
                    <td><?php echo $row['Insti_Head_Position']; ?> </td>
                    <td><a href="InstituteRegistration.php"> Edit </a></td>
                 </tr>
