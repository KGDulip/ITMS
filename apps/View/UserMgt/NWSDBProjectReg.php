                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card card-default">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Project_Cost_Code_ID" class="form-control" id="Project_Cost_Code_ID" placeholder="0071/15/360">
                                        </div>
                                        <!--<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Project_Autho_OfficerEmpNo" class="form-control" id="Project_Autho_OfficerEmpNo" placeholder="2049821">
                                        </div>
                                        <div class="form-group">
                                            <label>Officer Designation</label>
                                            <input type="text" name="Project_Autho_OfficerDesig" class="form-control" id="Project_Autho_OfficerDesig" placeholder="Perera A.B.C.">
                                        </div>
                                        <div class="form-group">
                                            <label>City</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Project_Name" class="form-control" id="Project_Name" placeholder="OIC Office (Kotte)">
                                        </div>
                                        <div class="form-group">
                                            <label>Officer Name</label>
                                            <input type="text" name="Project_Autho_OfficerName" class="form-control" id="Project_Autho_OfficerName" placeholder="Perera A.B.C.">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" name="Project_Email" class="form-control" id="Project_Email" placeholder="abc@gmail.com" >
                                        </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="View_NWSDBProjectReg.php" class="btn btn-primary">View</a>
                            </div>
                            </form>
                        </div>
                        <!-- /.card -->
