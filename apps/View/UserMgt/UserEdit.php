                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="User_Reg_Designation" class="form-control" id="User_Reg_Designation" value="<?php if(isset($_GET['User_Reg_Designation'])) echo $User_Reg_Designation;?>" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="User_Reg_Email" class="form-control" id="User_Reg_Email" value="<?php if(isset($_GET['User_Reg_Email'])) echo $User_Reg_Email;?>" />
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label>Photo</label>
                                                <input type="text" name="User_Reg_Photo" class="form-control" id="User_Reg_Photo" >
                                            </div>
                                            <div class="form-group">
