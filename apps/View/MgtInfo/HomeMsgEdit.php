                        ...
                        <div class="card card-default">
                            ...
                            <form id="quickForm" method="POST" action="../../Module/MgtInfo/_HomeMsg.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <input type="text" name="homemsg_name" class="form-control" id="homemsg_name" readonly="" value="<?php if (isset($_GET['homemsg_name'])) echo $homemsg_name; ?>" />
                                    </div>
                                    <div class="col-md-6 form-group mt-3 mt-md-0">
                                        <input type="email" class="form-control" name="homemsg_email" id="homemsg_email" readonly="" value="<?php if (isset($_GET['homemsg_email'])) echo $homemsg_email; ?>" />
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-6 form-group mt-3">
                                        <input type="text" name="homemsg_mobile" class="form-control" id="homemsg_mobile" readonly="" value="<?php if (isset($_GET['homemsg_mobile'])) echo $homemsg_mobile; ?>" />
                                    </div>
                                    <div class="col-md-6 form-group mt-3">
                                        <input type="text" class="form-control" name="homemsg_subject" id="homemsg_subject" readonly="" value="<?php if (isset($_GET['homemsg_subject'])) echo $homemsg_subject; ?>" />
                                    </div>
