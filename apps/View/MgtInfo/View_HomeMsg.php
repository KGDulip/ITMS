            ...
            <div class="content-wrapper">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    $sql="Select * from  tbl_homemsg ORDER BY homemsg_Date DESC";
                 ...
                 <tr>
                    <td><?php echo $row['homemsg_ID']; ?> </td>
                    <td><?php echo $row['homemsg_name']; ?> </td>
                    <td><?php echo $row['homemsg_email']; ?> </td>
                    <td><?php echo $row['homemsg_mobile']; ?> </td>
                    <td><?php echo $row['homemsg_subject']; ?> </td>
                    <td><?php echo $row['homemsg_message']; ?> </td>
                    <td><?php echo $row['homemsg_action']; ?> </td>
                    <td><?php echo $row['homemsg_remarks']; ?> </td>
                    <td><?php echo $row['homemsg_Date']; ?> </td>
                    <td><a href=_HomeMsgEdit.php?homemsg_ID=<?php echo $row['homemsg_ID'];?>> Edit </a></td>
                 </tr>
