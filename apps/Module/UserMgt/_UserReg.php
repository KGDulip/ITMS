...
try {
    ...
    if (isset($_POST['Update'])) {   /// This used to update values
        $sql = 'UPDATE tbl_user_registration '
                . 'SET User_Reg_No_Type=:User_Reg_No_Type,User_Reg_Name_Initial=:User_Reg_Name_Initial,User_Reg_Name_Surname=:User_Reg_Name_Surname,User_Reg_Signature=:User_Reg_Signature,User_Reg_Password=:User_Reg_Password,User_Reg_Photo=:User_Reg_Photo,User_Reg_Role=:User_Reg_Role, User_Reg_Is_Active=:User_Reg_Is_Active,User_Reg_Designation=:User_Reg_Designation,User_Reg_Email=:User_Reg_Email WHERE User_Reg_Emp_Cost_No=:User_Reg_Emp_Cost_No';

        $stmt = $conn->prepare($sql);
        $stmt->execute(array('User_Reg_Emp_Cost_No' => $User_Reg_Emp_Cost_No,'User_Reg_No_Type' => $User_Reg_No_Type,'User_Reg_Name_Initial' => $User_Reg_Name_Initial,'User_Reg_Name_Surname' => $User_Reg_Name_Surname,'User_Reg_Signature' => $User_Reg_Signature,'User_Reg_Password' => $User_Reg_Password,'User_Reg_Photo' => $User_Reg_Photo,'User_Reg_Role' => $User_Reg_Role,'User_Reg_Is_Active' => $User_Reg_Is_Active,'User_Reg_Designation' => $User_Reg_Designation,'User_Reg_Email' => $User_Reg_Email));
